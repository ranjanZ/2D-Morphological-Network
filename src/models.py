...
def model_CNN(input_shape=(512, 512, 1)):
    ...
    for n_filters in n_filters_down:
        ...
        x, down_link = unet_down_1(
            n_filters, x, activation=activation, n_layers=n_layers)
        back_links.append(down_link)
        depth += 1

    center, _ = unet_down_1(
        n_filters_center, x, activation=activation, pool=None, n_layers=n_layers_center)
    ...
    while depth > 0:
        ...
        x1 = unet_up_1(n_filters, x1, link,
